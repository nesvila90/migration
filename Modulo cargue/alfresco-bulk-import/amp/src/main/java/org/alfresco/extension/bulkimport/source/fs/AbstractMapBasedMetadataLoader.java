        ...
        if (metadataFile != null)
        {
            if (metadataFile.canRead())
            {
                ...
                if (metadataProperties != null)
                {
                    ...
                    {
                        //####_TODO: Issue #5 (https://github.com/pmonks/alfresco-bulk-import/issues/5): figure out how to handle properties of type cm:content - they need to be streamed in via a Writer
                    	QName              name               = QName.createQName(key, namespaceService);
                    	PropertyDefinition propertyDefinition = dictionaryService.getProperty(name);  // _TODO: measure performance impact of this API call!!
