               ...
               BulkImportCallback
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            //se retrasa la ejecución en 5000 milisegundos
            Thread.sleep(5000);
            ...
            System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
            System.out.println("----------------- Escanenado archivods /Scanner/  ------------------------ ");
            System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
            filePhase = true;
        ...
        catch (final Throwable t)
        {
                 ...
                 "com.hazelcast.core.RuntimeInterruptedException".equals(rootCauseClassName)))  // For compatibility across 4.x *sigh*
            {
                ...
                //TODO: llamar api de modulo migracion. En este se deberá actualizar todos los registros por uuid
                System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
                System.out.println("----------------- Se detuvo /Scanner/   ------------------------ ");
                System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
            }
            else
            {
    ...
    /*
                ...
                String resutadoAuditoria = Auditoria.auditarEjecucion(
              ...
              //TODO: llamar api de modulo migracion. En este se deberá actualizar todos los registros por uuid
                System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
                System.out.println("----------------- Fallo De ejecucion /Scanner/  ------------------------ ");
                System.out.println("||||||||||||||||||||||||||||||||||||||||||||||");
                System.out.println("Error por "+ t.getLocalizedMessage());
                t.printStackTrace();
